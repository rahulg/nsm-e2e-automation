...
class TestE2E005PaperFormE2E:
    ...
    def test_phase_2_staff_portal_verify_lt260_processed(self, staff_page: Page):
        ...
        # Auto-issuance lands the record in Processed asynchronously — a single search
        # right after Phase 1 found "No Records Found" (2026-09-14), minutes later it was
        # there. Poll the search instead of searching once.
        wait_for_vin_in_listing(page, lt260_listing.search_by_vin, TEST_VIN, "LT-260 Processed")
